...
SELECT SUM(DECODE(EXTRACT(YEAR FROM HIRE_DATE), 1998, 1, 0)) || '명' AS "1998년",
          SUM(DECODE(EXTRACT(YEAR FROM HIRE_DATE), 1999, 1, 0)) || '명' AS "1999년",
          SUM(DECODE(EXTRACT(YEAR FROM HIRE_DATE), 2000, 1, 0)) || '명' AS "2000년",
          SUM(DECODE(EXTRACT(YEAR FROM HIRE_DATE), 2001, 1, 0)) || '명' AS "2001년",
          SUM(DECODE(EXTRACT(YEAR FROM HIRE_DATE), 2002, 1, 0)) || '명' AS "2002년",
          SUM(DECODE(EXTRACT(YEAR FROM HIRE_DATE), 2003, 1, 0)) || '명' AS "2003년",
          SUM(DECODE(EXTRACT(YEAR FROM HIRE_DATE), 2004, 1, 0)) || '명' AS "2004년",
          COUNT(*) || '명' AS 전체직원
FROM EMPLOYEE;
